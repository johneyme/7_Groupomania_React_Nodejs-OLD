  ...
  render() {
    ...
    return (
      <div className="register">
          ...
          <br /><input type='text' id="identifiant" value={this.state.phone} onChange={this.onChangePhone} />
          ...
          <br /><input type="password" id="mdp" value={this.state.password} onChange={this.onChangePassword} />
